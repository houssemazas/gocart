    ...
    return (
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-white rounded-3xl xl:min-h-100 group'>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-[#D2CABD] rounded-3xl p-6 px-8 group'>
                        <div>
                        ...
                        <Image className='w-50' src={assets.hero_product_img1} alt="" />
                    </div>
